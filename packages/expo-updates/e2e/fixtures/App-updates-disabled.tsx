...
export default function App() {
  const [lastJSAPIErrorMessage, setLastJSAPIErrorMessage] = React.useState(false);
  ...
  const handleCallJSAPI = async () => {
    try {
      ...
      setLastJSAPIErrorMessage(e.message);
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TestValue testID="lastJSAPIErrorMessage" value={`${lastJSAPIErrorMessage}`} />
      <View style={{ flexDirection: 'row' }}>
        <View>
